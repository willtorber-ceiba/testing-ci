...
public class ManejadorError extends ResponseEntityExceptionHandler {
    ...
    public ManejadorError() {
        ...
        CODIGOS_ESTADO.put(ResourceNoFoundException.class.getSimpleName(), HttpStatus.NOT_FOUND.value());
        CODIGOS_ESTADO.put(GarantiaExtendidaAsignadaException.class.getSimpleName(), HttpStatus.FORBIDDEN.value());
    }
